	DE0_NANO_SOC_QSYS u0 (
		...
		.avalon_echo_input_beginbursttransfer    (<connected-to-avalon_echo_input_beginbursttransfer>),    //       avalon_echo_input.beginbursttransfer
		.avalon_leds_output_readdata             (<connected-to-avalon_leds_output_readdata>),             //      avalon_leds_output.readdata
		.avalon_trig_output_writeresponsevalid_n (<connected-to-avalon_trig_output_writeresponsevalid_n>), //      avalon_trig_output.writeresponsevalid_n
